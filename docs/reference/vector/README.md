...
| Quantization lifecycle | [`rrflow://rrflow-instance/data/reference/vector/quantization-lifecycle`](rrflow://rrflow-instance/data/reference/vector/quantization-lifecycle) | [`quantization-lifecycle.md`](quantization-lifecycle.md) | persistent build/activate/retire lifecycle and mmap codecs; native delta input remains open |
| Artifact residency | [`rrflow://rrflow-instance/data/reference/vector/memory-tiers`](rrflow://rrflow-instance/data/reference/vector/memory-tiers) | [`memory-tiers.md`](memory-tiers.md) | bounded process-local pinned/cached/cold policy exists; it is not rrflowMX, rrflowKV persistence, or the DataFusion memory pool |
| Compact dense artifact | [`rrflow://rrflow-instance/data/reference/vector/compact-dense-artifact`](rrflow://rrflow-instance/data/reference/vector/compact-dense-artifact) | [`compact-dense-artifact.md`](compact-dense-artifact.md) | verified aligned mmap format and exact kernels exist; it is not yet an Arrow/DataFusion page format |
