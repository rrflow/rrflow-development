...
| Remaining generated SDKs | OpenAPI and one shared semantic corpus exist as generation/conformance inputs. | Each supported language must run the same real-daemon corpus; schema generation alone is not qualification. |
