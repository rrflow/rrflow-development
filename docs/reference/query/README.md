...
| Live queries | [`rrflow://rrflow-instance/data/reference/query/live-query`](rrflow://rrflow-instance/data/reference/query/live-query) | [`live-query.md`](live-query.md) | deterministic snapshot-diff polling; commit-impact evaluation remains open |
