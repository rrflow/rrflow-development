...
| Java | [`rrflow://rrflow-instance/data/reference/sdk/java`](rrflow://rrflow-instance/data/reference/sdk/java) | [`java.md`](java.md) | generated synchronous 33-operation HTTP foundation; concrete operation types, secrets, semantic retry/cancellation, WebSocket, remote transport, reproducible offline Maven/JAR artifact, JDK/toolchain matrix, and release conformance remain open |
| .NET | [`rrflow://rrflow-instance/data/reference/sdk/dotnet`](rrflow://rrflow-instance/data/reference/sdk/dotnet) | [`dotnet.md`](dotnet.md) | generated asynchronous 33-operation HTTP foundation; concrete operation types, secrets, semantic retry/server cancellation, WebSocket, remote transport, reproducible signed NuGet artifact, SDK/runtime/platform matrix, and release conformance remain open |
