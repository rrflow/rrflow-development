...
| Release declarations | [`rrflow://rrflow-instance/data/reference-index/release`](rrflow://rrflow-instance/data/reference-index/release) | [`release/`](release/) | product version and compatibility-domain policy; readiness remains roadmap-owned |
