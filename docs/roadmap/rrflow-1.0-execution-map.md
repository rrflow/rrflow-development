...
| [ ] | A-07.1b | Rust SDK direct responsibility split and secret-safe public session boundary, preserving current characterized behavior. |
| [ ] | A-07.1c | TypeScript SDK direct responsibility split and direct conformance-test filename convergence. |
