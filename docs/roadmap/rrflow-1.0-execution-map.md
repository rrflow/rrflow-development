...
admission and B-04 multiplexed WebSocket work are also complete; B-05
GraphQL lowering is the next implementation package.
...
The governed-function sandbox is now directly located under
`engine/function/` with the A-07.1a contract names. C-03 replaces its remaining
private control records and split audit/commit behavior. I-01/I-02 connect its
proposals to the final event
