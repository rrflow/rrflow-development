...
|---:|---|---|
| 1 | `docs/operations/ci.md` | Re-read the retained CI owner, verify its index and commands, and record the final KB-05 supporting-file disposition. |

After row 1, run the complete KB-05/A-06 acceptance corpus and change the
