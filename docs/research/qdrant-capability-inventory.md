...
| Quantization has a ready/active/retired lifecycle, but full builds scan history and `ensure_vector_index` still reaches TurboQuant through a compatibility adapter. | C-05/J-01 remove the successful alternate path directly; E-04 retains only the one canonical lifecycle and required codecs after comparative evidence. |
