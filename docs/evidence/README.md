...
| C-06i rrflowKV physical-policy candidate screen | n/a | [`c06i-rrflowkv-physical-policy-linux-x86_64.json`](c06i-rrflowkv-physical-policy-linux-x86_64.json) | revision-bound fixed-machine candidate selection; not an integrated production policy, release proof, or competitor claim |
